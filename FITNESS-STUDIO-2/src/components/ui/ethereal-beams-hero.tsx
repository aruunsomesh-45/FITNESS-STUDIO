...
const CanvasWrapper: FC<{ children: ReactNode }> = ({ children }) => {
    ...
    if (!hasWebGL) {
        // Enhanced Fallback: Animated gradient background
        return (
...
export default function EtherealBeamsHero() {
    return (
        <div className="relative min-h-screen w-full overflow-hidden bg-black">
            ...
            {/* Hero Content */}
            <div className="relative z-10 flex min-h-screen items-center pt-20 pb-20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        {/* Main Heading */}
                        <div className="mb-6 text-3xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl uppercase overflow-hidden">
                            <SplitText text="Unleash Your Potential" className="text-white" />
                        </div>
                        ...
                        >
                            Experience the next evolution of fitness. Premium equipment, expert trainers, and a community that drives you forward.
                        </motion.p>
                        ...
                        >
                            <Button size="lg" className="shadow-2xl shadow-primary/25 font-semibold bg-primary text-black hover:bg-white">
                                Start Creating
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-white/60 text-sm">Trainers</div>
                            </div>
                            <div className="text-center">
