...
const SyntheticHero = ({
    ...
    useGSAP(
        () => {
            ...
            // Standard GSAP animation without SplitText
            ...
            // Animate heading as a whole block
            tl.to(
                headingRef.current,
                {
                    filter: "blur(0px)",
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6">
                ...
                <h1
                    ref={headingRef}
                    className="text-6xl md:text-8xl lg:text-9xl max-w-5xl font-bold uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-primary to-white/60 mb-6 leading-[0.9] drop-shadow-sm"
                >
                    {title}
                </h1>
